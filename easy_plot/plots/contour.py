...
def contour(df, scatter_sub_df='', xvar: str='', yvar: str='', zvar: str='', contour_levels=[], title='Contour Plot', bins=20, largest_fontsize: int=17, major_gridlines=False, minor_gridlines=False, xlim=[], ylim=[], xticks=[], yticks=[], xformat='', yformat='', label_format=default_label, colorbar=True) -> None:
    '''
